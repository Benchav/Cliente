...
function Guardar() {
    ...
    if ($("#form").valid()) {
        var request = {
            id: $("#txtid").val(),
            nombrecompañia: ($("#txtNombreCompañia").val() != "" ? $("#txtNombreCompañia").val() : ""),
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.resultado) {
                        ...
                        Swal.fire("Mensaje", "No se pudo eliminar el proveedor", "warning")
                    }
                },
                error: function (error) {
                    console.log(error)
